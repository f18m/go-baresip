// Package gobaresip provides a Go interface to the Baresip SIP client (https://github.com/baresip).
// This package allows you to control Baresip, send commands, and receive events and responses.
// It is designed to be used in applications that require SIP functionality, such as VoIP clients
